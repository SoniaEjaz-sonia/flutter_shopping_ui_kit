...
class DottedSlider extends StatefulWidget {
  const DottedSlider({super.key, this.color, this.children, this.maxHeight});
  ...
  @override
  State<DottedSlider> createState() => _DottedSliderState();
}
  ...
  dot(bool selected) {
    ...
    return Padding(
      ...
      child: Container(
        ...
        height: size,
        decoration:
            BoxDecoration(borderRadius: BorderRadius.circular(10), color: (selected) ? widget.color : Colors.black38),
      ),
    );
  }
}

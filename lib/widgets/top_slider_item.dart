          ...
          children: <Widget>[
            ...
            Positioned(
              ...
              child: Container(
                width: 130,
                height: 130,
                decoration: const BoxDecoration(image: DecorationImage(image: AssetImage('assets/slide_foot.png'))),
              ),
            ),
          ],
        ),
...
class SlideImageContainerClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    path.cubicTo(size.width / 2 - 10, size.height + 12, size.width, size.height + 40, size.width, 0);

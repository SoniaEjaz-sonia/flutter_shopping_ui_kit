...
import 'package:flutter_shopping_ui_kit/utils/colors.dart';
import 'package:flutter_shopping_ui_kit/widgets/dotted_slider.dart';
            ...
            children: <Widget>[
              const Row(
                children: <Widget>[
                  ...
                  Text(
                    "\$ 5.674",
                    style: TextStyle(color: Colors.black54, fontSize: 18, decoration: TextDecoration.lineThrough),
                  ),
                  SizedBox(
                    width: 6,
                  ),
        ...
        child: Column(
          ...
          children: <Widget>[
            Row(
              ...
              children: <Widget>[
                SizedBox(width: 130, child: Text("Front Camera")),
                SizedBox(
                  width: 48,
                ),
                Text("16 MP"),
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.start,
              children: <Widget>[
                SizedBox(width: 130, child: Text("Internal Storage")),
                SizedBox(
                  width: 48,
                ),
                Text("128 GB"),
        ...
        child: const Column(
          children: <Widget>[
            ...
            ListTile(
              ...
              subtitle: Text("Cats are good pets, for they are clean and are not noisy."),
              title: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
            ...
            ListTile(
              leading: CircleAvatar(
                backgroundImage: NetworkImage("https://www.familiadejesusperu.org/images/avatar/john-doe-13.jpg"),
              ),
              subtitle: Text("There was no ice cream in the freezer, nor did they have money to go to the store."),
              title: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
                  StarRating(rating: 4, size: 15),
            ...
            ListTile(
              leading: CircleAvatar(
                backgroundImage: NetworkImage("https://pbs.twimg.com/profile_images/1020903668240052225/_6uVaH4c.jpg"),
              ),
              subtitle: Text("I think I will buy the red car, or I will lease the blue one."),
              title: Row(
                mainAxisAlignment: MainAxisAlignment.start,
                children: <Widget>[
                  StarRating(rating: 4, size: 15),
